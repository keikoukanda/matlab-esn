...
input_data = csvread('Narma_input.csv'); %read the input data
target_data = csvread('Narma_target1.csv'); %read the taregt data (i.e. the delayed versions of the input in this case)
